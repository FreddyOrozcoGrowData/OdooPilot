...
#st.write(lead_ids)
leads = odoo.env['crm.lead'].read(lead_ids, ['active', 'name', 'partner_id', 'user_id', 'x_studio_linea', 'stage_id', 'team_id', 'x_studio_edopreventa', 'x_studio_preventa', 'x_studio_fecha_asignacion_preventa', 'x_studio_tipo_de_oportunidad', 'create_date', 'x_studio_fecha_entregap', 'x_vinculante_novinculante', 'expected_revenue', 'x_studio_consultoria_cop', 'x_studio_datos_cop', 'x_studio_ti_cop', 'date_deadline', 'write_date', 'x_studio_tipo_de_producto', 'won_status', 'write_date'])
